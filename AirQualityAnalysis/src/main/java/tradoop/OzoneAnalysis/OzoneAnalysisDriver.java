...
Deploy JAR file
   $ cd /home/tri/Documents/HadoopLab/AirQualityAnalysis/target/classes/
   $ jar cfv OzoneMR.jar ./tradoop/OzoneAnalysis/*.class
...
Run the Java Program (ssh and run on Hadoop node)
   ...
   # yarn jar OzoneMR.jar tradoop.OzoneAnalysis.OzoneAnalysisDriver -files /root/HadoopExo/Stations_v28012014.csv

   --Exec on HDFS (StationInfo added to DistribCache via API in MR Code)
   # yarn jar OzoneMR.jar tradoop.OzoneAnalysis.OzoneAnalysisDriver
   ...
   $ scp root@hdpsbhv:/root/HadoopExo/OzoneByCities_JavaMR.txt /home/tri/Documents/HadoopLab/AirQualityAnalysis/Results/
*/

/**
 * Chaining 2 MapReduce jobs to produce a report "Most polluted cities in Ozone"
 * See results: /home/tri/Documents/HadoopLab/AirQualityAnalysis/Results/OzoneByCities_JavaMR.txt
...
public class OzoneAnalysisDriver extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		job.setJobName("tradoop.OzoneAnalysis.OzoneAnalysisDriver #1 (GrpBy Location)");
		...
		job2.setJobName("tradoop.OzoneAnalysis.OzoneAnalysisDriver #2 (Order by MaxAvgOzone)");
