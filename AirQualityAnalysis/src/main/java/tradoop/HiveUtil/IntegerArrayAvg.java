...
Create JAR file
   ...
   $ jar cfv MyHiveUDF.jar ./tradoop/HiveUtil/*.class
   $ scp MyHiveUDF.jar root@hdpsbhv:/root/HadoopExo/Hive/

See how the UDF is used in /home/tri/Documents/HadoopLab/AirQualityAnalysis/src/main/hive/2_Ozone2012.hiveql
*/
