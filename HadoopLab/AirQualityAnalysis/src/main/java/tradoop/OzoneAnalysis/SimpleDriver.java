...
Data Preparation (USING _SAME_ data files than HIVE, on HDFS)
   $ scp /home/tri/Documents/HadoopLab/AirQualityAnalysis/src/main/resources/Stations_v28012014.csv root@hdpsbhv:/root/HadoopExo/Hive/Data/
   $ scp /home/tri/Documents/HadoopLab/AirQualityAnalysis/src/main/resources/MiniOzoneSample.txt root@hdpsbhv:/root/HadoopExo/Hive/Data/
   ...
   $ scp /home/tri/Documents/HadoopLab/AirQualityAnalysis/src/main/resources/2012O3.hly root@hdpsbhv:/root/HadoopExo/Hive/Data/
...
Run the Java Program (ssh and run on Hadoop node)
  ...
  --Exec on HDFS (StationInfo added to DistribCache via API in MR Code)
   # yarn jar OzoneMR.jar tradoop.OzoneAnalysis.SimpleDriver
